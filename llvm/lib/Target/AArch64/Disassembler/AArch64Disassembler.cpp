...
DecodeStatus DecodeSImm(MCInst &Inst, unsigned Imm, uint64_t Address,
                        const MCDisassembler *Decoder);
static DecodeStatus DecodeSealForm(MCInst &Inst, unsigned Imm, uint64_t Address,
                                   const MCDisassembler *Decoder);
...
DecodeThreeAddrSRegInstruction(MCInst &Inst, uint32_t insn, uint64_t Address,
                               const MCDisassembler *Decoder);
static DecodeStatus
DecodeMorelloCapSystemRegister(MCInst &Inst, unsigned Imm, uint64_t Address,
                               const MCDisassembler *Decoder);
...
static bool Has16CapabilityRegisters(const MCDisassembler *Decoder) {
...
static DecodeStatus DecodeCAddSubImmInstruction(MCInst &Inst, uint32_t insn,
                                                uint64_t Addr,
                                                const MCDisassembler *Decoder) {
...
static DecodeStatus DecodeC64CapToGPR(MCInst &Inst, unsigned Reg, uint64_t Addr,
                                      const MCDisassembler *Decoder) {
  auto &STI = Decoder->getSubtargetInfo();
