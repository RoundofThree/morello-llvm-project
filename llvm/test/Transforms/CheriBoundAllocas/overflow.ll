...
; RUN: %riscv32_cheri_purecap_opt -opaque-pointers=0 -cheri-bound-allocas -S < %s | FileCheck %s
; RUN: %riscv32_cheri_purecap_opt -opaque-pointers=1 -instsimplify -cheri-bound-allocas -S < %s | FileCheck %s --check-prefix=OPAQUE
...
; CHECK-NEXT:    ret void
;
; OPAQUE-LABEL: @test_store(
; OPAQUE-NEXT:    [[TMP1:%.*]] = alloca [4 x i8], align 1, addrspace(200)
; OPAQUE-NEXT:    [[TMP2:%.*]] = call ptr addrspace(200) @llvm.cheri.bounded.stack.cap.i32(ptr addrspace(200) [[TMP1]], i32 4)
; OPAQUE-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr addrspace(200) [[TMP2]], i32 2147483646
; OPAQUE-NEXT:    store volatile i32 [[A:%.*]], ptr addrspace(200) [[TMP3]], align 2
...
; CHECK-NEXT:    ret void
;
; OPAQUE-LABEL: @test_setbounds(
; OPAQUE-NEXT:    [[TMP1:%.*]] = alloca [4 x i8], align 1, addrspace(200)
; OPAQUE-NEXT:    [[TMP2:%.*]] = call ptr addrspace(200) @llvm.cheri.bounded.stack.cap.i32(ptr addrspace(200) [[TMP1]], i32 4)
; OPAQUE-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr addrspace(200) [[TMP2]], i32 2147483646
; OPAQUE-NEXT:    [[TMP4:%.*]] = call ptr addrspace(200) @llvm.cheri.cap.bounds.set.i32(ptr addrspace(200) [[TMP3]], i32 4)
; OPAQUE-NEXT:    call void @use(ptr addrspace(200) [[TMP4]])
; OPAQUE-NEXT:    ret void
;
  %1 = alloca [4 x i8], align 1, addrspace(200)
  %2 = bitcast [4 x i8] addrspace(200)* %1 to i8 addrspace(200)*
