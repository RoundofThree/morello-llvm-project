...
; OPAQUE-NEXT:    [[X:%.*]] = alloca [16 x i32], align 4, addrspace(200)
; OPAQUE-NEXT:    [[TMP0:%.*]] = call ptr addrspace(200) @llvm.cheri.bounded.stack.cap.i64(ptr addrspace(200) [[X]], i64 64)
; OPAQUE-NEXT:    [[X_I8:%.*]] = bitcast ptr addrspace(200) [[TMP0]] to ptr addrspace(200)
; OPAQUE-NEXT:    [[X_PLUS_4:%.*]] = getelementptr inbounds i8, ptr addrspace(200) [[X_I8]], i32 4
...
; DBG-NEXT:       cheri-bound-allocas:   -Checking if getelementptr needs stack bounds:   %x_plus_4 = getelementptr inbounds i8, {{.+}} %x_i8, i32 4
