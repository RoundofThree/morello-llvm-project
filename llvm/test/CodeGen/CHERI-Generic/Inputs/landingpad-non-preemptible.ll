...
@IF-MORELLO@; CHECK-NEXT:  .byte 156                             {{#|//}} @TType Encoding = indirect pcrel sdata8
@IFNOT-MORELLO@; CHECK-NEXT:  .byte 155                             {{#|//}} @TType Encoding = indirect pcrel sdata4
...
@IF-MORELLO@; CHECK-NEXT:  [[TTYPE_DIRECTIVE:\.(8byte|xword)]]
@IFNOT-MORELLO@; CHECK-NEXT:  [[TTYPE_DIRECTIVE:\.(4byte|word)]]
