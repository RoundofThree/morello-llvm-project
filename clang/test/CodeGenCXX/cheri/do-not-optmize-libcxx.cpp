...
// RXUN: %cheri_cc1 -S -o - %s  -O2 | %cheri_FileCheck %s -check-prefixes ASM,N64_ASM
// RXUN: %cheri_purecap_cc1 -S -o - %s -O2 | %cheri_FileCheck %s -check-prefixes ASM,PURECAP_ASM

// This previously crashed:
// RXUN: %cheri_purecap_cc1 -DERROR_CHECK -S -o - %s -O2 -verify | %cheri_FileCheck %s -check-prefixes ASM,PURECAP_ASM,WITH_ERROR_ASM
