// RUN: %clang_cc1 -triple aarch64-none-elf -target-feature +c64 -target-abi purecap -mllvm -cheri-cap-table-abi=pcrel -fno-rtti \
// RUN:            -std=c++14 -fsyntax-only -fdump-record-layouts %s -emit-llvm -o /dev/null | FileCheck %s
