...
// HYBRID-NEXT:  entry:
// HYBRID-NEXT:    [[TMP0:%.*]] = call i64 @llvm.cheri.cap.load.tags.i64.p0i8(i8* [[PTR:%.*]])
// HYBRID-NEXT:    call void @use_size_t(i64 noundef zeroext [[TMP0]]) #[[ATTR5]]
// HYBRID-NEXT:    ret void
//
// PURECAP-LABEL: @test_loadtags(
// PURECAP-NEXT:  entry:
// PURECAP-NEXT:    [[TMP0:%.*]] = call i64 @llvm.cheri.cap.load.tags.i64.p200i8(i8 addrspace(200)* [[PTR:%.*]])
// PURECAP-NEXT:    call void @use_size_t(i64 noundef zeroext [[TMP0]]) #[[ATTR5]]
