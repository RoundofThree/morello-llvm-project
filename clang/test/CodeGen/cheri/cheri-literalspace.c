...
// RUN: %clang_cc1 -triple aarch64 -fno-signed-char -target-feature +morello -target-feature +c64 -target-abi purecap %s -O0 -emit-llvm -o - | FileCheck %s --check-prefix=AARCH64
