...
Value *CodeGenFunction::EmitAArch64BuiltinExpr(unsigned BuiltinID,
  ...
  if (BuiltinID == clang::AArch64::BI__builtin_morello_chkssu ||
      BuiltinID == clang::AArch64::BI__builtin_morello_subset_test_unseal_or_null) {
    Value *Arg0 = EmitScalarExpr(E->getArg(0));
    Value *Arg1 = EmitScalarExpr(E->getArg(1));
    Value *Call = Builder.CreateCall(
  ...
  if ((BuiltinID == clang::AArch64::BI__builtin_arm_ldrex ||
    ...
    Value *LdPtr = EmitScalarExpr(E->getArg(0));
    Function *F = CGM.getIntrinsic(BuiltinID == clang::AArch64::BI__builtin_arm_ldaex
    ...
    LoadAddr = Builder.CreateBitCast(LoadAddr, PtrTy);
    unsigned Op = (BuiltinID == clang::AArch64::BI__builtin_arm_ldaex
                                       ? Intrinsic::aarch64_ldaxr
                                       : Intrinsic::aarch64_ldxr);
    if (IsCap)
      Op = (BuiltinID == clang::AArch64::BI__builtin_arm_ldaex
  ...
  if ((BuiltinID == clang::AArch64::BI__builtin_arm_strex ||
    ...
    Value *StPtr = Builder.CreateBitCast(EmitScalarExpr(E->getArg(1)),
                                         Int8PtrTy);
    Function *F = CGM.getIntrinsic(BuiltinID == clang::AArch64::BI__builtin_arm_stlex
  ...
  if (BuiltinID == clang::AArch64::BI__builtin_arm_strex ||
    ...
    unsigned Op = BuiltinID == clang::AArch64::BI__builtin_arm_stlex
                                       ? Intrinsic::aarch64_stlxr
                                       : Intrinsic::aarch64_stxr;
    if (IsCap)
      Op = BuiltinID == clang::AArch64::BI__builtin_arm_stlex
