...
RegisterInfoPOSIX_arm64::RegisterInfoPOSIX_arm64(
  ...
  case llvm::Triple::aarch64_32: {
    ...
    m_per_regset_regnum_range[CapRegSet] = std::make_pair(cap_c0, cap_ddc + 1);
    m_per_regset_regnum_range[StateRegSet] =
        std::make_pair(state_rddc_el0, state_sp_el0 + 1);
    m_per_regset_regnum_range[ThreadRegSet] =
        std::make_pair(thread_ctpidr_el0, thread_tpidr_el0 + 1);
